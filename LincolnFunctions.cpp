...
list<course> readCourses() // This function will read the file and input the data in to the program. The .txt file should be saved in a particular order, depending on the type of structure it is
{
...
list<vacancy> readVacancies() // This function will read the file and input the data in to the program. The .txt file should be saved in a particular order, depending on the type of structure it is
{
	list<vacancy> readVacancy;
	list<vacancy>::iterator p = readVacancy.begin();
	string line;
	ifstream infile;
	int i = 0;
	string dataArray[2];
